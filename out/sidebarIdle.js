...
<body>
  <main class='shell'>
    ...
    <div class='eyebrow'>${(0, i18n_1.t)(lang, 'sidebar.eyebrow')}</div>
    <h1>${title}</h1>
    ...
    <div class='progress-card' role='status' aria-live='polite' aria-busy='true'>
      <div class='progress-row'>
        ...
        <div class='progress-copy'>
          <div class='progress-title'>${(0, i18n_1.t)(lang, 'sidebar.compilingLabel')}</div>
          <div class='progress-hint'>${(0, i18n_1.t)(lang, 'sidebar.startingHint')}</div>
        </div>
      </div>
    ...
    <div class='action-area'>
      <button type='button' id='startPreview'>
        ...
        <span>${(0, i18n_1.t)(lang, 'sidebar.start')}</span>
      </button>
      <div class='hint'><span class='hint-dot' aria-hidden='true'></span>${(0, i18n_1.t)(lang, 'sidebar.startHint')}</div>
    </div>`}
  </main>
...
//# sourceMappingURL=sidebarIdle.js.map